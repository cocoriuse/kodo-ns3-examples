...
return true;
      ...
      if(from==des){
       std::cout << "Heollo:" << h1.GetACK()<< endl;
return true;
}
      ...
      if ( recode == 1 && h1.GetACK()==0)
        {
         NS_LOG_DEBUG("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"<<h1.GetACK());
                                                                 ...
                                                                 Packet > packet1, uint16_t type, const Address & from)
{
  ...
  //Mac48Address des = Mac48Address ("00:00:00:00:00:01");
  //Mac48Address source = Mac48Address ("00:00:00:00:00:02");  
  Mac48Address des= m_mac->GetAddress ();
  NS_ASSERT (Mac48Address::IsMatchingType (from));
  Mac48Address source = Mac48Address::ConvertFrom (from);
          ...
          for (int i = 0; i < (max_symbols); i++)
            {
             ...
             m_receiveCallback (this, pkt, type, des);
